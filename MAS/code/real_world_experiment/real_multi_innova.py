...
def move(goal_pose,agent):
      ...
      while not check_goal_reached(init_pose, goal_pose, 0.05):
        ...
        elif theta<0.3 and theta>-0.3:
            angular = klinear * theta
            # linear = klinear * theta
            twist.angular.z = -angular
...
# init_pose1 = rospy.wait_for_message('/id89/aruco_single/pose', PoseStamped)
# init_pose2 = rospy.wait_for_message('/id125/aruco_single/pose', PoseStamped)
# init_pose=[init_pose1,init_pose2]
...
# TODO: use the below code in your main function
